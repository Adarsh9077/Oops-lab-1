...
public:
    int car_no;
    void display(void) 
    // display function is already a virtual function in Vehicle class
    {
        cout << " Vehicle No. is " << vehicle_no << endl;
...
{
    Vehicle *veh_ptr; 
    // a pointer to vehicle class is created;
    Car cr;           // object of class car
    cr.car_no = 9077;
    veh_ptr = &cr; 
    // reference of object of class Car is assigned to the pointer.
    veh_ptr->vehicle_no = 108;
