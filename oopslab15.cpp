...
public:
    ...
    //a function to take mileage of a car as input
    {
        mileage = distance;
    }
    void getWeight(int wt /*in kiloGrams*/) 
    //a function to take weight of a car as input
    {
        weight = wt;
    }
    void displaycar(void) 
    //A display function to display all the car details;
    {
...
public:
    ...
    //a member function to take speed of a petrol car as input
    {
        max_speed = speed;
    }
};
class Electric : public Car  
// class Electric which is derived from class Car
{
public:
    ...
    void getMaxspeed(int speed /*in kmph*/) 
    //a member function to take speed of an electric car as input
    {
        max_speed = speed;
    }
};
...
public:
    ...
    {  /*It inherits all the properties of Electric class and 
    Electric class inherits all the properties
       of Car class;*/
        type = "Electric";
        mileage = 50;
        max_speed = 480;
...
public:
    ...
    {  /*It inherits all the properties of Petrol class 
    and Petrol class inherits all the properties
       of Car class;*/
        type = "Petrol";
        mileage = 60;
        max_speed = 580;
...
class Bmw : public Petrol,public Electric 
//class Bmw which is a hybrid car i.e. both petrol and electric;
{
    public:
    Bmw()  //Default constructor
    {   /*In order to solve the ambiguity due to the use of same data member of
     class Car through both class Petrol and Electric,so any one of them is 
     used (petrol) using scope resolution operator (::) */
        Petrol::type="Hybrid";  
