...
empty method named number of sides().Provided three class named Trapeziod , 
Triangle , and Hexagon such that each of the classes inherit the class shape
Each of the class contain the only method number of sides() that shows the 
...
{
public:
    void no_of_sides(void); 
    // Empty method 'no_of_sides()' of class Shape;
};
...
public:
    void no_of_sides() 
    // class trapezoid inherits the function of its base class i.e class Shape;
    {
        // Defination of 'no_of_sides()' method for Trapezoid class.
        cout << "No of sides of Trapezoid is\t: "<<setw(1) << 4 << endl;
    }
};
...
public:
    void no_of_sides() 
    // class Triangle inherits the function of its base class i.e class Shape;
    {
        // Defination of 'no_of_sides()' method for Triangle class.
        cout << "No of sides of Triangle is\t:"<<setw(2) << 3 << endl;
    }
};
...
public:
    void no_of_sides() 
    // class Hexagon inherits the function of its base class i.e class Shape;
    {
        // Defination of 'no_of_sides()' method for Hexagon class.
        cout << "No of sides of Hexagon is\t:"<<setw(2) << 6 << endl;
    }
};
